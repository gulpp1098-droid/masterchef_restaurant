...
import net.mcreator.omnichef.procedures.ChairMobOnInitialEntitySpawnProcedure;
import net.mcreator.omnichef.procedures.ChairMobOnEntityTickUpdateProcedure;
...
public class ChairMobEntity extends PathfinderMob {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		ChairMobOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ChairMobOnEntityTickUpdateProcedure.execute(this);
	}
