package net.mcreator.omnichef.entity;
...
public class CriticEntity extends PathfinderMob {
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(CriticEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(CriticEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_Sit = SynchedEntityData.defineId(CriticEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Walk = SynchedEntityData.defineId(CriticEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Idle = SynchedEntityData.defineId(CriticEntity.class, EntityDataSerializers.BOOLEAN);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public CriticEntity(EntityType<CriticEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 1) {
			...
			public boolean canUse() {
				double x = CriticEntity.this.getX();
				double y = CriticEntity.this.getY();
				double z = CriticEntity.this.getZ();
				Entity entity = CriticEntity.this;
				Level world = CriticEntity.this.level();
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		CriticOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		CriticOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
