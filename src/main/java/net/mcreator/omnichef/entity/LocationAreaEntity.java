...
import net.mcreator.omnichef.procedures.LocationAreaOnInitialEntitySpawnProcedure;
import net.mcreator.omnichef.procedures.LocationAreaColorChangeProcedure;
...
public class LocationAreaEntity extends PathfinderMob {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		LocationAreaOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		LocationAreaColorChangeProcedure.execute(this.level(), this.getX(), this.getZ(), this);
	}
