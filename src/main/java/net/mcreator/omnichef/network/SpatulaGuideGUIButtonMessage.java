...
public record SpatulaGuideGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<SpatulaGuideGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "spatula_guide_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(SpatulaGuideGUIButtonMessage.TYPE, SpatulaGuideGUIButtonMessage.STREAM_CODEC, SpatulaGuideGUIButtonMessage::handleData);
	}
}