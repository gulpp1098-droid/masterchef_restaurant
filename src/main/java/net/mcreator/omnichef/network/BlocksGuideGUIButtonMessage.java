...
public record BlocksGuideGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<BlocksGuideGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "blocks_guide_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(BlocksGuideGUIButtonMessage.TYPE, BlocksGuideGUIButtonMessage.STREAM_CODEC, BlocksGuideGUIButtonMessage::handleData);
	}
}