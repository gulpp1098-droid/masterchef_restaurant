...
public record BlocksGuideP5GUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<BlocksGuideP5GUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "blocks_guide_p_5_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(BlocksGuideP5GUIButtonMessage.TYPE, BlocksGuideP5GUIButtonMessage.STREAM_CODEC, BlocksGuideP5GUIButtonMessage::handleData);
	}
}