...
public record BlocksGuideP3GUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<BlocksGuideP3GUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "blocks_guide_p_3_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(BlocksGuideP3GUIButtonMessage.TYPE, BlocksGuideP3GUIButtonMessage.STREAM_CODEC, BlocksGuideP3GUIButtonMessage::handleData);
	}
}