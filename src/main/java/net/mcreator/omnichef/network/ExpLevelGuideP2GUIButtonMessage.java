...
public record ExpLevelGuideP2GUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<ExpLevelGuideP2GUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "exp_level_guide_p_2_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(ExpLevelGuideP2GUIButtonMessage.TYPE, ExpLevelGuideP2GUIButtonMessage.STREAM_CODEC, ExpLevelGuideP2GUIButtonMessage::handleData);
	}
}