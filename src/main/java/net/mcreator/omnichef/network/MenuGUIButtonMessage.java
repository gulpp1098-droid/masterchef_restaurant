...
import net.mcreator.omnichef.procedures.NextMenuPreviousPageProcedure;
import net.mcreator.omnichef.procedures.NextMenuNextPageProcedure;
...
public record MenuGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<MenuGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "menu_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(MenuGUIButtonMessage.TYPE, MenuGUIButtonMessage.STREAM_CODEC, MenuGUIButtonMessage::handleData);
	}
}