...
import net.mcreator.omnichef.procedures.MenuPacketToServerProcedureProcedure;
...
public record MenuPacketToServerMessage(String extradata) implements CustomPacketPayload {
	public static final Type<MenuPacketToServerMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "menu_packet_to_server"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(MenuPacketToServerMessage.TYPE, MenuPacketToServerMessage.STREAM_CODEC, MenuPacketToServerMessage::handleData);
	}
}