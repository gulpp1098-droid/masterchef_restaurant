...
import net.mcreator.omnichef.procedures.CheckboxPacketToClientProcedureProcedure;
...
public record CheckboxPacketToClientMessage(String extradata) implements CustomPacketPayload {
	public static final Type<CheckboxPacketToClientMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "checkbox_packet_to_client"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(CheckboxPacketToClientMessage.TYPE, CheckboxPacketToClientMessage.STREAM_CODEC, CheckboxPacketToClientMessage::handleData);
	}
}