...
import net.mcreator.omnichef.procedures.OverlayPacketReceivedByClientProcedure;
...
public record OverlayPacketMessage(String extradata) implements CustomPacketPayload {
	public static final Type<OverlayPacketMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "overlay_packet"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(OverlayPacketMessage.TYPE, OverlayPacketMessage.STREAM_CODEC, OverlayPacketMessage::handleData);
	}
}