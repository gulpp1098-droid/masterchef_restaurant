...
import net.mcreator.omnichef.procedures.LevelUpAnimationReceivedByClientProcedure;
...
public record LevelUpAnimationMessage(String extradata) implements CustomPacketPayload {
	public static final Type<LevelUpAnimationMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "level_up_animation"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(LevelUpAnimationMessage.TYPE, LevelUpAnimationMessage.STREAM_CODEC, LevelUpAnimationMessage::handleData);
	}
}