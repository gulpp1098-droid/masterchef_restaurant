...
public record LocationGuideGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<LocationGuideGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "location_guide_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(LocationGuideGUIButtonMessage.TYPE, LocationGuideGUIButtonMessage.STREAM_CODEC, LocationGuideGUIButtonMessage::handleData);
	}
}