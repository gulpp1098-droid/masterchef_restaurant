...
import net.mcreator.omnichef.procedures.PatiancePacketToClientProcedureProcedure;
...
public record PatiancePacketToClientMessage(String extradata) implements CustomPacketPayload {
	public static final Type<PatiancePacketToClientMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "patiance_packet_to_client"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OmnichefMod.addNetworkMessage(PatiancePacketToClientMessage.TYPE, PatiancePacketToClientMessage.STREAM_CODEC, PatiancePacketToClientMessage::handleData);
	}
}