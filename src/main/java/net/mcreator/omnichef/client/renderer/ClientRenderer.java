...
import net.mcreator.omnichef.client.model.animations.ClientNewAnimation;
import net.mcreator.omnichef.client.model.ModelClientBase;

public class ClientRenderer extends MobRenderer<ClientEntity, ModelClientBase<ClientEntity>> {
	private final ResourceLocation entityTexture = ResourceLocation.parse("omnichef:textures/entities/textureclient01.png");
