...
import net.mcreator.omnichef.world.inventory.BlocksGuideP5GUIMenu;
import net.mcreator.omnichef.network.BlocksGuideP5GUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class BlocksGuideP5GUIScreen extends AbstractContainerScreen<BlocksGuideP5GUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/blocks_guide_p_5_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			...
			if (true) {
				...
				net.minecraft.resources.ResourceLocation guiTools$image = guiTools$dynamicTexture("", net.minecraft.resources.ResourceLocation.parse("omnichef:textures/screens/queuerug_crafting.png"));
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.blocks_guide_p_5_gui.label_service_table"), -145, -98, -12829636, false);
