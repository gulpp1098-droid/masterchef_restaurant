...
import net.mcreator.omnichef.world.inventory.ChefsDiaryMenuGUIMenu;
import net.mcreator.omnichef.network.ChefsDiaryMenuGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryMenuGUIScreen extends AbstractContainerScreen<ChefsDiaryMenuGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/chefs_diary_menu_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.chefs_diary_menu_gui.label_food_wip"), -140, -98, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.chefs_diary_menu_gui.label_current_menu"), 7, -86, -3407821, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.chefs_diary_menu_gui.label_current_menu_copy"), 7, -35, -3407821, false);
