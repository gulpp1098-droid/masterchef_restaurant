...
import net.mcreator.omnichef.world.inventory.BlocksGuideP3GUIMenu;
import net.mcreator.omnichef.network.BlocksGuideP3GUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class BlocksGuideP3GUIScreen extends AbstractContainerScreen<BlocksGuideP3GUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/blocks_guide_p_3_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			...
			if (true) {
				...
				net.minecraft.resources.ResourceLocation guiTools$image = guiTools$dynamicTexture("", net.minecraft.resources.ResourceLocation.parse("omnichef:textures/screens/servicetable_crafting.png"));
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.blocks_guide_p_3_gui.label_service_table"), -145, -98, -12829636, false);
	...
	public void init() {
		...
		imagebutton_next_page_icon = new ImageButton(this.leftPos + 108, this.topPos + 57, 16, 16,
				new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/next_page_icon.png"), ResourceLocation.parse("omnichef:textures/screens/next_page_icon.png")), e -> {
					...
					int y = BlocksGuideP3GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP3GUIButtonMessage(6, x, y, z));
						BlocksGuideP3GUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
