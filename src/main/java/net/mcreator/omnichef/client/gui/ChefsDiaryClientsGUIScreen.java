...
import net.mcreator.omnichef.world.inventory.ChefsDiaryClientsGUIMenu;
import net.mcreator.omnichef.network.ChefsDiaryClientsGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryClientsGUIScreen extends AbstractContainerScreen<ChefsDiaryClientsGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/chefs_diary_clients_gui.png");
	...
	public ChefsDiaryClientsGUIScreen(ChefsDiaryClientsGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.chefs_diary_clients_gui.label_clients_wip"), -145, -98, -12829636, false);
		this.guiTools$renderMultilineLabel(guiGraphics,
				"Customers visit your restaurant in groups. The number of groups expected during a shift depends on active Service Tables in your restaurant. Group sizes depend on the chairs available at your active tables. Larger tables allow larger groups. A group will only choose a Service Table with enough chairs for every member of the group.",
				-145, -87, 126, 40, -12829636, false, 1.00F, 0, 0);
	}
	...
	public void init() {
		...
		imagebutton_base_icon = new ImageButton(this.leftPos + 147, this.topPos + -98, 18, 18, new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/base_icon.png"), ResourceLocation.parse("omnichef:textures/screens/base_icon.png")),
				e -> {
					int x = ChefsDiaryClientsGUIScreen.this.x;
					int y = ChefsDiaryClientsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryClientsGUIButtonMessage(0, x, y, z));
						ChefsDiaryClientsGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_food_icon = new ImageButton(this.leftPos + 148, this.topPos + -68, 18, 18, new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/food_icon.png"), ResourceLocation.parse("omnichef:textures/screens/food_icon.png")),
				e -> {
					...
					int y = ChefsDiaryClientsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryClientsGUIButtonMessage(1, x, y, z));
						ChefsDiaryClientsGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_clients_icon = new ImageButton(this.leftPos + 149, this.topPos + -39, 18, 18,
				new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/clients_icon.png"), ResourceLocation.parse("omnichef:textures/screens/clients_icon.png")), e -> {
					...
					int y = ChefsDiaryClientsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryClientsGUIButtonMessage(2, x, y, z));
						ChefsDiaryClientsGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_appliences_icon = new ImageButton(this.leftPos + 148, this.topPos + -11, 18, 18,
				new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/appliences_icon.png"), ResourceLocation.parse("omnichef:textures/screens/appliences_icon.png")), e -> {
					...
					int y = ChefsDiaryClientsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryClientsGUIButtonMessage(3, x, y, z));
						ChefsDiaryClientsGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_stats_icon = new ImageButton(this.leftPos + 147, this.topPos + 17, 18, 18, new WidgetSprites(ResourceLocation.parse("omnichef:textures/screens/stats_icon.png"), ResourceLocation.parse("omnichef:textures/screens/stats_icon.png")),
				e -> {
					...
					int y = ChefsDiaryClientsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryClientsGUIButtonMessage(4, x, y, z));
						ChefsDiaryClientsGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
