...
import net.mcreator.omnichef.world.inventory.LocationGuideGUIMenu;
import net.mcreator.omnichef.network.LocationGuideGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class LocationGuideGUIScreen extends AbstractContainerScreen<LocationGuideGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/location_guide_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.location_guide_gui.label_overview_wip"), -145, -98, -12829636, false);
