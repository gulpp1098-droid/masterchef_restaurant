...
import net.mcreator.omnichef.world.inventory.ChefsDiaryApplienceGUIMenu;
import net.mcreator.omnichef.network.ChefsDiaryApplienceGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryApplienceGUIScreen extends AbstractContainerScreen<ChefsDiaryApplienceGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/chefs_diary_applience_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.chefs_diary_applience_gui.label_appliences_wip"), -145, -98, -12829636, false);
	}
