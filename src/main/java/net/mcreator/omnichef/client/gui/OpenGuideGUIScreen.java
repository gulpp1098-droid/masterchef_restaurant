...
import net.mcreator.omnichef.world.inventory.OpenGuideGUIMenu;
import net.mcreator.omnichef.network.OpenGuideGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class OpenGuideGUIScreen extends AbstractContainerScreen<OpenGuideGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/open_guide_gui.png");
	...
	private static final ResourceLocation IMAGE_2 = ResourceLocation.parse("omnichef:textures/screens/open_icon.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.open_guide_gui.label_overview_wip"), -145, -98, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.open_guide_gui.label_as_well_as_claim_area"), -145, -30, -65485, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.open_guide_gui.label_inside_this_area_you_can"), 5, -34, -65485, false);
		this.guiTools$renderMultilineLabel(guiGraphics, "When your restaurant is ready, use the Golden Spatula to open the restaurant menu and press the Open button.", -145, -84, 132, 71, -12829636, false, 1.00F, 0, 0);
		this.guiTools$renderMultilineLabel(guiGraphics, "Your restaurant can only be opened once per day, between 6:00 and 15:00. After that, you will need to wait until the next day.", -145, -15, 127, 72, -12829636, false, 1.00F, 0, 0);
		this.guiTools$renderMultilineLabel(guiGraphics, "Once opened, customers will begin arriving, wait in the queue, find a table and place their orders.", 5, -84, 128, 51, -12829636, false, 1.00F, 0, 0);
		this.guiTools$renderMultilineLabel(guiGraphics, "Your restaurant closes automatically 8 in-game hours after opening (around 13 minutes). You can also close it earlier whenever you are done serving customers.", 5, -22, 127, 84, -12829636,
				false, 1.00F, 0, 0);
	}
