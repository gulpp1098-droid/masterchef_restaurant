...
import net.mcreator.omnichef.world.inventory.SpatulaGuideGUIMenu;
import net.mcreator.omnichef.network.SpatulaGuideGUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class SpatulaGuideGUIScreen extends AbstractContainerScreen<SpatulaGuideGUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/spatula_guide_gui.png");
	...
	private static final ResourceLocation IMAGE_4 = ResourceLocation.parse("omnichef:textures/screens/separator_icon.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			...
			if (true) {
				...
				net.minecraft.resources.ResourceLocation guiTools$image = guiTools$dynamicTexture("", net.minecraft.resources.ResourceLocation.parse("omnichef:textures/screens/spatula_crafting.png"));
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.spatula_guide_gui.label_overview_wip"), -145, -98, -12829636, false);
