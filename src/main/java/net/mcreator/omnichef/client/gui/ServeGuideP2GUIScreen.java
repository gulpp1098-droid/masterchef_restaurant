...
import net.mcreator.omnichef.world.inventory.ServeGuideP2GUIMenu;
import net.mcreator.omnichef.network.ServeGuideP2GUIButtonMessage;
import net.mcreator.omnichef.init.OmnichefModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ServeGuideP2GUIScreen extends AbstractContainerScreen<ServeGuideP2GUIMenu> implements OmnichefModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("omnichef:textures/screens/serve_guide_p_2_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.serve_guide_p_2_gui.label_overview_wip"), -145, -98, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.omnichef.serve_guide_p_2_gui.label_more_space_to_claim_for"), 5, -98, -12829636, false);
		this.guiTools$renderMultilineLabel(guiGraphics,
				"Customers lose patience while waiting in the queue, waiting to order or waiting for food. If their patience gets too low, they may leave unhappy. Serve them quickly to keep your customers satisfied and your restaurant growing!",
				-145, -84, 130, 137, -12829636, false, 1.00F, 0, 0);
		this.guiTools$renderMultilineLabel(guiGraphics, "Some customers may order more than one dish. Serve every ordered item before they can start eating. More dishes become available as your restaurant level increases.", 5, -84, 127, 103,
