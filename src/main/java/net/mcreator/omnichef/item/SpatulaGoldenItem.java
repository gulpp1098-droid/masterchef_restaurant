...
import net.mcreator.omnichef.procedures.SpatulaInHandOnTickProcedure;
import net.mcreator.omnichef.procedures.SetRestaurantLocalizationWithSpatulaProcedure;
import net.mcreator.omnichef.procedures.IsSpatulaInSelectingLocationStateProcedure;
...
public class SpatulaGoldenItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.omnichef.spatula_golden.description_0"));
	}
