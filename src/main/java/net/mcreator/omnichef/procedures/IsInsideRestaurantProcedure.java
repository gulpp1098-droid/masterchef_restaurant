...
public class IsInsideRestaurantProcedure {
	public static boolean execute(LevelAccessor world, double dependencyX, double dependencyZ, double restaurantID) {
		...
		double ParameterX = 0;
		double ParameterZ = 0;
		locationsArray = GetRestaurantArrayParameterProcedure.execute(RestaurantIndexSearchByIDProcedure.execute(world, restaurantID), "restaurants", "locations", OmnichefModVariables.MapVariables.get(world).Restaurant_File_Name,
