...
public class RugUpdateStateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (Direction directioniterator : Direction.Plane.HORIZONTAL) {
			if (directioniterator == Direction.NORTH && OmnichefModBlocks.RUG.get() == (world.getBlockState(BlockPos.containing(x + directioniterator.getStepX(), y, z + directioniterator.getStepZ()))).getBlock()) {
				amountRugs = amountRugs + 1;
				North = true;
			} else if (directioniterator == Direction.SOUTH && OmnichefModBlocks.RUG.get() == (world.getBlockState(BlockPos.containing(x + directioniterator.getStepX(), y, z + directioniterator.getStepZ()))).getBlock()) {
				amountRugs = amountRugs + 1;
				South = true;
			} else if (directioniterator == Direction.WEST && OmnichefModBlocks.RUG.get() == (world.getBlockState(BlockPos.containing(x + directioniterator.getStepX(), y, z + directioniterator.getStepZ()))).getBlock()) {
				amountRugs = amountRugs + 1;
				West = true;
			} else if (directioniterator == Direction.EAST && OmnichefModBlocks.RUG.get() == (world.getBlockState(BlockPos.containing(x + directioniterator.getStepX(), y, z + directioniterator.getStepZ()))).getBlock()) {
				amountRugs = amountRugs + 1;
				East = true;
			}
		}
		amountRugsDiag = 0;
		if (OmnichefModBlocks.RUG.get() == (world.getBlockState(BlockPos.containing(x + 1, y, z + 1))).getBlock()) {
			SE = true;
