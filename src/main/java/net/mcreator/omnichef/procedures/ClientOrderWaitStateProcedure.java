...
public class ClientOrderWaitStateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		Entity client = null;
		client = entity;
		if (sourceentity.getData(OmnichefModVariables.PLAYER_VARIABLES).Restaurant_ID == client.getPersistentData().getDouble("RestaurantID")
			...
			{
				OmnichefModVariables.PlayerVariables _vars = sourceentity.getData(OmnichefModVariables.PLAYER_VARIABLES);
