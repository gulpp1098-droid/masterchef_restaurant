...
public class PartServedReturnProcedure {
	public static String execute(Entity entity) {
		...
		if (entity.getData(OmnichefModVariables.PLAYER_VARIABLES).Restaurant_ID >= 0) {
			...
			if (entity.getData(OmnichefModVariables.PLAYER_VARIABLES).GUIstring.contains("customers_served")) {
				return Data.get("customers_served").getAsString();
			}
		}
		return "0";
	}
