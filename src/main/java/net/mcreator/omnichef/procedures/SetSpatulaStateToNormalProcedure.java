...
public class SetSpatulaStateToNormalProcedure {
	...
	public record SetSpatulaStateToNormalMessage() implements CustomPacketPayload {
		public static final Type<SetSpatulaStateToNormalMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OmnichefMod.MODID, "procedure_set_spatula_state_to_normal"));
		...
		public static void registerMessage(FMLCommonSetupEvent event) {
			OmnichefMod.addNetworkMessage(SetSpatulaStateToNormalMessage.TYPE, SetSpatulaStateToNormalMessage.STREAM_CODEC, SetSpatulaStateToNormalMessage::handleData);
		}
	}
