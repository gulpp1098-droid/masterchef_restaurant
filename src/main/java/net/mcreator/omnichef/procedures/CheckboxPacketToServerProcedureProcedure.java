...
import net.mcreator.omnichef.network.CheckboxPacketToClientMessage;
...
public class CheckboxPacketToServerProcedureProcedure {
	public static void execute(LevelAccessor world, Entity entity, String inboundString) {
		if (entity == null || inboundString == null)
			return;
		if ((world instanceof ServerLevel _level0 ? getEntityFromUUID(_level0, inboundString) : null) != null && (inboundString).equals(entity.getData(OmnichefModVariables.PLAYER_VARIABLES).CurrentClientUUID)
