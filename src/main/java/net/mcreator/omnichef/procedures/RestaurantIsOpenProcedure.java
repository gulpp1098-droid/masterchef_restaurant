...
public class RestaurantIsOpenProcedure {
	public static void execute(LevelAccessor world, Entity entity, double ChairAmount, double TablesAmount) {
		...
		clientsFile = new File(OmnichefModVariables.MapVariables.get(world).Restaurant_Info_Path, File.separator + OmnichefModVariables.MapVariables.get(world).ClientsDatabase_File_Name);
		{
			try {
				...
				restaurantObject.addProperty("ID", ((int) entity.getData(OmnichefModVariables.PLAYER_VARIABLES).Restaurant_ID));
