...
public class NotServedReturnProcedure {
	public static String execute(Entity entity) {
		...
		if (entity.getData(OmnichefModVariables.PLAYER_VARIABLES).Restaurant_ID >= 0) {
			...
			if (entity.getData(OmnichefModVariables.PLAYER_VARIABLES).GUIstring.contains("customers_lost")) {
				return Data.get("customers_lost").getAsString();
			}
		}
		return "0";
	}
