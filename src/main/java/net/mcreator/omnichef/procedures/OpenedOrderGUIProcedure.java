...
public class OpenedOrderGUIProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (world.getLevelData().getGameTime() % 5 == 0) {
			if ((entity instanceof Player _guiToolsDisplayPlayer1 && _guiToolsDisplayPlayer1.containerMenu instanceof OmnichefModMenus.MenuAccessor _guiToolsDisplayMenu1
