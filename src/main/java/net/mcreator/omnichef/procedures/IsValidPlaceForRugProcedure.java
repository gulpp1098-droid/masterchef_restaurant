...
public class IsValidPlaceForRugProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if (world.getBlockState(BlockPos.containing(x, y - 1, z)).canOcclude()) {
			return true;
		} else if (!world.isClientSide() && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == OmnichefModBlocks.RUG_QUEUE.get() && !getBlockNBTLogic(world, BlockPos.containing(x, y, z), "cleanup_started")) {
