...
public class GeneratePendingCardsProcedure {
	public static void execute(LevelAccessor world, double restaurantID) {
		...
		options = GetRestaurantArrayParameterProcedure.execute(restaurantIndex, "restaurants", "unlock_options", MasterchefRestaurantModVariables.MapVariables.get(world).RestaurantFood_File_Name,
		...
		ModifyRestaurantWholeArrayParameterProcedure.execute(pendingCards, restaurantIndex, "restaurants", "pending_cards", MasterchefRestaurantModVariables.MapVariables.get(world).RestaurantFood_File_Name,
				MasterchefRestaurantModVariables.MapVariables.get(world).Restaurant_Info_Path);
	}
}