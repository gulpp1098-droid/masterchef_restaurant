...
public class ModifyRestaurantLogicParameterProcedure {
	public static void execute(boolean logicDependency, double numberIndex, String arrayNameDependency, String fileNameDependency, String filePathDependency, String propertyDependency) {
		...
		ListOfRestaurants = new File(filePathDependency, File.separator + fileNameDependency);
		{
			try {
				...
				Restaurant.addProperty(propertyDependency, logicDependency);
				{
