...
public class ModifyRestaurantWholeArrayParameterProcedure {
	public static void execute(com.google.gson.JsonArray arrayValueDependency, double numberIndex, String arrayNameDependency, String arrayParameterNameDependency, String fileNameDependency, String filePathDependency) {
		if (arrayValueDependency == null || arrayNameDependency == null || arrayParameterNameDependency == null || fileNameDependency == null || filePathDependency == null)
			return;
		...
		ListOfRestaurants = new File(filePathDependency, File.separator + fileNameDependency);
		{
			try {
				...
				Restaurant.add(arrayParameterNameDependency, arrayValueDependency);
				{
