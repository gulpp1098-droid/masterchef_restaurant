...
import net.mcreator.masterchefrestaurant.world.inventory.ChefsDiaryApplienceGUIMenu;
import net.mcreator.masterchefrestaurant.network.ChefsDiaryApplienceGUIButtonMessage;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryApplienceGUIScreen extends AbstractContainerScreen<ChefsDiaryApplienceGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/chefs_diary_applience_gui.png");
	...
	public ChefsDiaryApplienceGUIScreen(ChefsDiaryApplienceGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.chefs_diary_applience_gui.label_appliences_wip"), -145, -103, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_base_icon = new ImageButton(this.leftPos + 147, this.topPos + -98, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png")), e -> {
					int x = ChefsDiaryApplienceGUIScreen.this.x;
					int y = ChefsDiaryApplienceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryApplienceGUIButtonMessage(0, x, y, z));
						ChefsDiaryApplienceGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_food_icon = new ImageButton(this.leftPos + 148, this.topPos + -68, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png")), e -> {
					...
					int y = ChefsDiaryApplienceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryApplienceGUIButtonMessage(1, x, y, z));
						ChefsDiaryApplienceGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_clients_icon = new ImageButton(this.leftPos + 149, this.topPos + -39, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png")), e -> {
					...
					int y = ChefsDiaryApplienceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryApplienceGUIButtonMessage(2, x, y, z));
						ChefsDiaryApplienceGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_appliences_icon = new ImageButton(this.leftPos + 148, this.topPos + -11, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png")), e -> {
					...
					int y = ChefsDiaryApplienceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryApplienceGUIButtonMessage(3, x, y, z));
						ChefsDiaryApplienceGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_stats_icon = new ImageButton(this.leftPos + 147, this.topPos + 17, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png")), e -> {
					...
					int y = ChefsDiaryApplienceGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryApplienceGUIButtonMessage(4, x, y, z));
						ChefsDiaryApplienceGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
