...
import net.mcreator.masterchefrestaurant.world.inventory.ChefsDiaryClientsGUIMenu;
import net.mcreator.masterchefrestaurant.network.ChefsDiaryClientsGUIButtonMessage;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryClientsGUIScreen extends AbstractContainerScreen<ChefsDiaryClientsGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/chefs_diary_clients_gui.png");
