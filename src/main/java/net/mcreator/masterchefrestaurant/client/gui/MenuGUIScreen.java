...
public class MenuGUIScreen extends AbstractContainerScreen<MenuGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food3namereturn"), 71, 16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food4namereturn"), 71, 51, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food6namereturn"), 71, 87, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food4rewardreturn"), 110, 32, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food5rewardreturn"), 110, 67, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.menu_gui.label_food6rewardreturn"), 110, 105, -12829636, false);
	}
