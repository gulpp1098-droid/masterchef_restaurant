...
import net.mcreator.masterchefrestaurant.world.inventory.RelocateConfirmationGUIMenu;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class RelocateConfirmationGUIScreen extends AbstractContainerScreen<RelocateConfirmationGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/relocate_confirmation_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			if (true) {
				...
				net.minecraft.resources.ResourceLocation guiTools$image = guiTools$dynamicTexture("", net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/newrestaurantgui.png"));
	...
	public void init() {
		super.init();
		enhanced_image_button_openclosebutton_icon = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -119, this.topPos + 13, 81, 31,
				...
				e -> {
					...
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage(0, x, y, z));
						net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		enhanced_image_button_openclosebutton_icon_copy = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -36, this.topPos + 13, 81, 31,
				new net.minecraft.client.gui.components.WidgetSprites(net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/openclosebutton_icon.png"),
						net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/openclosebutton_icon.png")),
				e -> {
					int x = RelocateConfirmationGUIScreen.this.x;
					int y = RelocateConfirmationGUIScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage(1, x, y, z));
						net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(net.minecraft.client.gui.GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		enhanced_image_button_openclosebutton_icon_copy_copy = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 47, this.topPos + 13, 81, 31,
				new net.minecraft.client.gui.components.WidgetSprites(net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/openclosebutton_icon.png"),
						net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/openclosebutton_icon.png")),
				e -> {
					int x = RelocateConfirmationGUIScreen.this.x;
					int y = RelocateConfirmationGUIScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage(2, x, y, z));
						net.mcreator.masterchefrestaurant.network.RelocateConfirmationGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(net.minecraft.client.gui.GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
