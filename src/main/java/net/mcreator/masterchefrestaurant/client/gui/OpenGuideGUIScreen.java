...
public class OpenGuideGUIScreen extends AbstractContainerScreen<OpenGuideGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.open_guide_gui.label_overview_wip"), -145, -98, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.open_guide_gui.label_as_well_as_claim_area"), -145, -30, -65485, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.open_guide_gui.label_inside_this_area_you_can"), 5, -34, -65485, false);
