...
import net.mcreator.masterchefrestaurant.world.inventory.ChefsDiaryTipsGUIMenu;
import net.mcreator.masterchefrestaurant.network.ChefsDiaryTipsGUIButtonMessage;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class ChefsDiaryTipsGUIScreen extends AbstractContainerScreen<ChefsDiaryTipsGUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/chefs_diary_tips_gui.png");
	...
	public ChefsDiaryTipsGUIScreen(ChefsDiaryTipsGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.chefs_diary_tips_gui.label_food_wip"), -140, -98, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.chefs_diary_tips_gui.label_food_wip_copy"), 8, -98, -12829636, false);
		this.guiTools$renderMultilineLabel(guiGraphics,
				"The Timeline shows the customer groups scheduled to visit your restaurant during the current shift. Each marker represents one group, and its position on the Timeline shows when that group is expected to spawn. Critics have their own special marker, making them easy to spot before they arrive.",
				-140, -87, 126, 43, -12829636, false, 1.00F, 0, 0);
		this.guiTools$renderMultilineLabel(guiGraphics,
				"Your restaurant will close automatically at the end of the shift, but you can also close it early. After closing, no new customer groups will arrive. Customers who haven't been seated yet will leave, while customers already seated at a Service Table can finish their visit normally. Once closed, the restaurant cannot be reopened until the next day.",
				8, -87, 126, 43, -12829636, false, 1.00F, 0, 0);
	}
	...
	public void init() {
		...
		imagebutton_base_icon = new ImageButton(this.leftPos + 147, this.topPos + -98, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png")), e -> {
					int x = ChefsDiaryTipsGUIScreen.this.x;
					int y = ChefsDiaryTipsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryTipsGUIButtonMessage(0, x, y, z));
						ChefsDiaryTipsGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_food_icon = new ImageButton(this.leftPos + 148, this.topPos + -68, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png")), e -> {
					...
					int y = ChefsDiaryTipsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryTipsGUIButtonMessage(1, x, y, z));
						ChefsDiaryTipsGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_clients_icon = new ImageButton(this.leftPos + 149, this.topPos + -39, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png")), e -> {
					...
					int y = ChefsDiaryTipsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryTipsGUIButtonMessage(2, x, y, z));
						ChefsDiaryTipsGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_appliences_icon = new ImageButton(this.leftPos + 148, this.topPos + -11, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png")), e -> {
					...
					int y = ChefsDiaryTipsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryTipsGUIButtonMessage(3, x, y, z));
						ChefsDiaryTipsGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_stats_icon = new ImageButton(this.leftPos + 147, this.topPos + 17, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png")), e -> {
					...
					int y = ChefsDiaryTipsGUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ChefsDiaryTipsGUIButtonMessage(4, x, y, z));
						ChefsDiaryTipsGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
