...
import net.mcreator.masterchefrestaurant.world.inventory.BlocksGuideP4GUIMenu;
import net.mcreator.masterchefrestaurant.network.BlocksGuideP4GUIButtonMessage;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class BlocksGuideP4GUIScreen extends AbstractContainerScreen<BlocksGuideP4GUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/blocks_guide_p_4_gui.png");
	...
	public BlocksGuideP4GUIScreen(BlocksGuideP4GUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			...
			if (true) {
				...
				net.minecraft.resources.ResourceLocation guiTools$image = guiTools$dynamicTexture("", net.minecraft.resources.ResourceLocation.parse("masterchef_restaurant:textures/screens/chair_crafting.png"));
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.masterchef_restaurant.blocks_guide_p_4_gui.label_service_table"), -145, -98, -12829636, false);
		this.guiTools$renderMultilineLabel(guiGraphics,
				"Chairs provide seats for customers at your Service Tables. Place them next to a Service Table to make them part of that table.\nThe number of Chairs determines how many customers can sit together at the table. Make sure every group has enough room to sit!",
	...
	public void init() {
		...
		imagebutton_base_icon = new ImageButton(this.leftPos + 147, this.topPos + -98, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/base_icon.png")), e -> {
					int x = BlocksGuideP4GUIScreen.this.x;
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(0, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_food_icon = new ImageButton(this.leftPos + 148, this.topPos + -68, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/food_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(1, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_clients_icon = new ImageButton(this.leftPos + 149, this.topPos + -39, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/clients_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(2, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_appliences_icon = new ImageButton(this.leftPos + 148, this.topPos + -11, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/appliences_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(3, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_stats_icon = new ImageButton(this.leftPos + 147, this.topPos + 17, 18, 18,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/stats_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(4, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_last_page_icon = new ImageButton(this.leftPos + -141, this.topPos + 57, 16, 16,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/last_page_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/last_page_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(5, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_next_page_icon = new ImageButton(this.leftPos + 108, this.topPos + 57, 16, 16,
				new WidgetSprites(ResourceLocation.parse("masterchef_restaurant:textures/screens/next_page_icon.png"), ResourceLocation.parse("masterchef_restaurant:textures/screens/next_page_icon.png")), e -> {
					...
					int y = BlocksGuideP4GUIScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new BlocksGuideP4GUIButtonMessage(6, x, y, z));
						BlocksGuideP4GUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
