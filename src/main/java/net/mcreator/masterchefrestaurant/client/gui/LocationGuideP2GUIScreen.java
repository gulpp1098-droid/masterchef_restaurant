...
import net.mcreator.masterchefrestaurant.world.inventory.LocationGuideP2GUIMenu;
import net.mcreator.masterchefrestaurant.network.LocationGuideP2GUIButtonMessage;
import net.mcreator.masterchefrestaurant.init.MasterchefRestaurantModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class LocationGuideP2GUIScreen extends AbstractContainerScreen<LocationGuideP2GUIMenu> implements MasterchefRestaurantModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("masterchef_restaurant:textures/screens/location_guide_p_2_gui.png");
