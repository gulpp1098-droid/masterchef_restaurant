...
public record CardsPickGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<CardsPickGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(MasterchefRestaurantMod.MODID, "cards_pick_gui_buttons"));
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		guiTools$enhancedImageButton : {
			if (buttonID == 0) {
				net.mcreator.masterchefrestaurant.procedures.ChooseCard1Procedure.execute(world, x, y, z, entity);
			}
			if (buttonID == 1) {
				net.mcreator.masterchefrestaurant.procedures.ChooseCard2Procedure.execute(world, x, y, z, entity);
			}
			if (buttonID == 2) {
				net.mcreator.masterchefrestaurant.procedures.ChooseCard3Procedure.execute(world, x, y, z, entity);
			}
		}
	}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MasterchefRestaurantMod.addNetworkMessage(CardsPickGUIButtonMessage.TYPE, CardsPickGUIButtonMessage.STREAM_CODEC, CardsPickGUIButtonMessage::handleData);
	}
}