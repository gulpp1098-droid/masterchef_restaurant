...
import net.mcreator.masterchefrestaurant.client.CameraShakeManager;

@EventBusSubscriber
public record CameraShakePayload(float power, int durationTicks) implements CustomPacketPayload {
	public static final CustomPacketPayload.Type<CameraShakePayload> TYPE = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath("masterchef_restaurant", "camera_shake"));
