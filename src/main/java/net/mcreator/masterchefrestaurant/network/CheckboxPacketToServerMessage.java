...
import net.mcreator.masterchefrestaurant.procedures.CheckboxPacketToServerProcedureProcedure;
...
public record CheckboxPacketToServerMessage(String extradata) implements CustomPacketPayload {
	public static final Type<CheckboxPacketToServerMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(MasterchefRestaurantMod.MODID, "checkbox_packet_to_server"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MasterchefRestaurantMod.addNetworkMessage(CheckboxPacketToServerMessage.TYPE, CheckboxPacketToServerMessage.STREAM_CODEC, CheckboxPacketToServerMessage::handleData);
	}
}