...
public class ModelClientNew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "clientnew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Rightleg = Legs.addOrReplaceChild("Rightleg", CubeListBuilder.create().texOffs(32, 0).addBox(
				-9.5F, -2.0F, -2.5F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(5.5F, -2.0F, 4.5F));

		PartDefinition Leftleg = Legs.addOrReplaceChild("Leftleg", CubeListBuilder.create().texOffs(24, 31).addBox(
				-9.5F, -2.0F, -2.5F, 9.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(5.5F, -2.0F, -4.5F));
		...
		PartDefinition SunGlasses = Head.addOrReplaceChild("SunGlasses", CubeListBuilder.create().texOffs(40, 47)
				.addBox(-4.5F, -6.0F, -4.5F, 0.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = SunGlasses
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(40, 39).addBox(-0.5F, -3.5F, -4.5F, 0.0F, 8.0F, 9.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -1.5F, 4.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r2 = SunGlasses.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(40, 39).addBox(-0.5F, -3.5F, -4.5F, 0.0F, 8.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.5F, -5.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r3 = SunGlasses.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 41).addBox(0.0F, -5.0F, -4.5F, 0.0F, 9.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -4.5F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition Torso = UpperBody.addOrReplaceChild("Torso", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Hips = Torso.addOrReplaceChild("Hips",
				CubeListBuilder.create().texOffs(40, 40)
						.addBox(-2.0F, -5.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						.addBox(-3.0F, -12.0F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Chest = Torso.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 31).addBox(-2.0F,
				-24.0F, -3.0F, 6.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = Lefthand.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(44, 23).addBox(-1.5F, -2.0F, -3.0F, 5.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 12.0F, -3.0F, -0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Lefthand
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(32, 9).addBox(-2.0F, 0.0084F, -3.9939F, 4.0F, 14.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Righthand
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(24, 40).addBox(-2.0F, 0.0084F, 0.0061F, 4.0F, 14.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Righthand.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(44, 23).addBox(-1.5F, -2.0F, -3.0F, 5.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
